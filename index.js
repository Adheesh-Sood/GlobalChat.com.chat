...
function SendMessage(){
    usernameFinals = document.getElementById('username').value;
    document.getElementById('username').disabled = true; // Lock the username input
    console.log(usernameFinals)
    const m = ref(database, 'usernames');
    const n = push(m);
    set(n, {
      username:usernameFinals
      });
